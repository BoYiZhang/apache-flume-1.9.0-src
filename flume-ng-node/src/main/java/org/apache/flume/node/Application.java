  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (isZkConfigured) {
        ...
        logger.info(" 未配置 isZkConfigured .........  ");
        ...
        if (reload) {
          ...
          logger.info(" 开始启动程序: PollingPropertiesFileConfigurationProvider " );
          ...
          logger.info(" create EventBus ==>  "+ eventBus);
      ...
      logger.info(" 启动 application ,监控程序运行.. ==>  "+ application);
      application.start();
